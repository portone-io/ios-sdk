...
public struct Customer: Codable {
  ...
  public init(
    customerId: String? = nil, fullName: String? = nil, firstName: String? = nil,
    lastName: String? = nil, phoneNumber: String? = nil, email: String? = nil,
    address: Address? = nil, zipcode: String? = nil, gender: Gender? = nil,
    birthYear: String? = nil, birthMonth: String? = nil, birthDay: String? = nil,
    firstNameKana: String? = nil, lastNameKana: String? = nil
  ) {
