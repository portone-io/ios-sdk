...
/// **다날 bypass 파라미터**
public struct DanalIdentityVerificationBypass: Codable {
    ...
    public let isCarrier: String?

    private enum CodingKeys: String, CodingKey {
        case cptitle = "CPTITLE"
        case agelimit = "AGELIMIT"
        case isCarrier = "IsCarrier"
    }

    public init(cptitle: String? = nil, agelimit: Int? = nil, isCarrier: String? = nil) {
