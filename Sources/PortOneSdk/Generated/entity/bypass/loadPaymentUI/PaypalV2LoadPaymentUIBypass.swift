...
public struct PaypalV2LoadPaymentUIBypass: Codable {
  ...
  public init(
    style: LoadPaymentUiPaypalV2Style? = nil, enableFunding: String? = nil,
    disableFunding: String? = nil, purchaseUnits: [PaypalV2PurchaseUnit]? = nil,
    payer: PaypalV2Payer? = nil, additionalData: [LoadPaymentUiPaypalV2AdditionalData]? = nil
  ) {
    self.style = style
