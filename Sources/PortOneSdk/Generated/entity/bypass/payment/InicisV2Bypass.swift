...
public struct InicisV2Bypass: Codable {
  ...
  public init(
    logoUrl: String? = nil, logo2Nd: String? = nil, parentemail: String? = nil,
    iniSsgpayMdn: String? = nil, acceptmethod: [String]? = nil, pCardOption: String? = nil,
    pMname: String? = nil, pReserved: [String]? = nil
  ) {
