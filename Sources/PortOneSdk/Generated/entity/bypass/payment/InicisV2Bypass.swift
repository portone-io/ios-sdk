...
public struct InicisV2Bypass: Codable {
    /// **PC용 파라미터**
    /// 
    /// 결제창에 삽입할 메인 로고 url
    /// 
    ...
    /// 
    /// `-` 없이 숫자만 허용합니다.
    public let iniSsgpayMdn: String?
    /// **PC용 파라미터**
    /// 
    /// 추가 옵션
    /// 
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case parentemail
        case iniSsgpayMdn = "Ini_SSGPAY_MDN"
        case acceptmethod
    ...
    public init(logoUrl: String? = nil, logo2Nd: String? = nil, parentemail: String? = nil, iniSsgpayMdn: String? = nil, acceptmethod: [String]? = nil, pCardOption: String? = nil, pMname: String? = nil, pReserved: [String]? = nil) {
        self.logoUrl = logoUrl
        self.logo2Nd = logo2Nd
        self.parentemail = parentemail
        self.iniSsgpayMdn = iniSsgpayMdn
