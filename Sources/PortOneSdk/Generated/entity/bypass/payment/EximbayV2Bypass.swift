...
public struct EximbayV2Bypass: Codable {
    ...
    public init(payment: PaymentEximbayV2Payment? = nil, merchant: PaymentEximbayV2Merchant? = nil, tax: EximbayV2Tax? = nil, surcharge: [PaymentEximbayV2Surcharge]? = nil, shipTo: PaymentEximbayV2ShipTo? = nil, billTo: PaymentEximbayV2BillTo? = nil, settings: EximbayV2Settings? = nil) {
