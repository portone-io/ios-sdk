...
public struct IssueBillingKeyAndPayResponse: Codable {
  ...
  public init(
    transactionType: String, billingKey: String, billingIssueToken: String? = nil,
    paymentId: String, txId: String, code: String? = nil, message: String? = nil,
    pgCode: String? = nil, pgMessage: String? = nil
  ) {
