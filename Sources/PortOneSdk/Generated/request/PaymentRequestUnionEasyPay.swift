...
public struct PaymentRequestUnionEasyPay: Codable {
    ...
    public init(easyPayProvider: EasyPayProvider? = nil, useFreeInterestFromMall: Bool? = nil, availableCards: [CardCompany]? = nil, installment: Installment? = nil, cashReceiptType: CashReceiptType? = nil, customerIdentifier: String? = nil, useCardPoint: Bool? = nil, availablePayMethods: [EasyPayPaymentMethod]? = nil, useInstallment: Bool? = nil) {
