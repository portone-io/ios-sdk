...
public struct IssueBillingKeyAndPayRequest: Codable {
    ...
    public init(storeId: String, paymentId: String, orderName: String, totalAmount: Int, currency: Currency, channelKey: String? = nil, billingKeyAndPayMethod: BillingKeyAndPayMethod, taxFreeAmount: Int? = nil, vatAmount: Int? = nil, customer: Customer? = nil, products: [Product]? = nil, windowType: WindowTypes? = nil, forceRedirect: Bool? = nil, noticeUrls: [String]? = nil, locale: PortOneLocale? = nil, isCulturalExpense: Bool? = nil, customData: JSONValue? = nil, offerPeriod: OfferPeriod? = nil, appScheme: String? = nil, productType: ProductType? = nil, storeDetails: StoreDetails? = nil, country: Country? = nil, bypass: IssueBillingKeyAndPayBypass? = nil, popup: Popup? = nil, iframe: Iframe? = nil, mobile: IssueBillingKeyAndPayRequestUnionMobile? = nil) {
