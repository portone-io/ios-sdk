...
public struct IssueBillingKeyAndPayRequest: Codable {
  /// **상점 아이디**
  ///
  ...
  /// 빌링키 발급 및 초회결제 수단
  public let billingKeyAndPayMethod: BillingKeyAndPayMethod
  /// **면세 금액**
  ///
  /// 미입력 시 0으로 취급됩니다.
  ...
  public let bypass: IssueBillingKeyAndPayBypass?
  /// **팝업 관련 필드**
  ///
  ...
  public let mobile: IssueBillingKeyAndPayRequestUnionMobile?

  public init(
    storeId: String, paymentId: String, orderName: String, totalAmount: Int, currency: Currency,
    channelKey: String? = nil, billingKeyAndPayMethod: BillingKeyAndPayMethod,
    taxFreeAmount: Int? = nil, vatAmount: Int? = nil, customer: Customer? = nil,
    products: [Product]? = nil, windowType: WindowTypes? = nil, forceRedirect: Bool? = nil,
    noticeUrls: [String]? = nil, locale: PortOneLocale? = nil, isCulturalExpense: Bool? = nil,
    customData: JSONValue? = nil, offerPeriod: OfferPeriod? = nil, appScheme: String? = nil,
    productType: ProductType? = nil, storeDetails: StoreDetails? = nil, country: Country? = nil,
    bypass: IssueBillingKeyAndPayBypass? = nil, popup: Popup? = nil, iframe: Iframe? = nil,
    mobile: IssueBillingKeyAndPayRequestUnionMobile? = nil
  ) {
    ...
    self.billingKeyAndPayMethod = billingKeyAndPayMethod
