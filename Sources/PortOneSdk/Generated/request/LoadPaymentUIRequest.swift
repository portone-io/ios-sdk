...
public struct LoadPaymentUIRequest: Codable {
    ...
    public init(uiType: PaymentUIType, storeId: String, paymentId: String, orderName: String, totalAmount: Int, channelKey: String, taxFreeAmount: Int? = nil, vatAmount: Int? = nil, customer: Customer? = nil, noticeUrls: [String]? = nil, confirmUrl: String? = nil, appScheme: String? = nil, isEscrow: Bool? = nil, products: [Product]? = nil, isCulturalExpense: Bool? = nil, currency: Currency, locale: PortOneLocale? = nil, customData: JSONValue? = nil, offerPeriod: OfferPeriod? = nil, productType: ProductType? = nil, storeDetails: StoreDetails? = nil, bypass: LoadPaymentUIBypass? = nil, country: Country? = nil, shippingAddress: Address? = nil, promotionGroupId: String? = nil, promotionIds: [String]? = nil) {
        self.uiType = uiType
