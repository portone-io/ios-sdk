...
public struct LoadPaymentUIRequest: Codable {
  public let uiType: PaymentUIType
  /// **상점 아이디**
  ///
  ...
  public let bypass: LoadPaymentUIBypass?
  /// **국가**
  ///
  ...
  /// 프로모션 그룹 ID
  public let promotionGroupId: String?
  /// 프로모션 ID 목록
  public let promotionIds: [String]?

  public init(
    uiType: PaymentUIType, storeId: String, paymentId: String, orderName: String, totalAmount: Int,
    channelKey: String, taxFreeAmount: Int? = nil, vatAmount: Int? = nil, customer: Customer? = nil,
    ...
    currency: Currency, locale: PortOneLocale? = nil, customData: JSONValue? = nil,
    offerPeriod: OfferPeriod? = nil, productType: ProductType? = nil,
    storeDetails: StoreDetails? = nil, bypass: LoadPaymentUIBypass? = nil, country: Country? = nil,
    shippingAddress: Address? = nil, promotionGroupId: String? = nil, promotionIds: [String]? = nil
  ) {
    self.uiType = uiType
    ...
    self.promotionGroupId = promotionGroupId
