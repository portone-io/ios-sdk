...
public struct PaymentRequestUnionCard: Codable {
  ...
  public init(
    cardCompany: CardCompany? = nil, availableCards: [CardCompany]? = nil,
    useFreeInterestFromMall: Bool? = nil, installment: Installment? = nil,
    useCardPoint: Bool? = nil, useAppCardOnly: Bool? = nil, useInstallment: Bool? = nil,
    cardPromotion: CardPromotion? = nil
  ) {
