...
public struct PaymentRequest: Codable {
  ...
  public init(
    storeId: String, paymentId: String, orderName: String, orderDetail: String? = nil,
    totalAmount: Int, currency: Currency, payMethod: PaymentPayMethod, channelKey: String? = nil,
    channelGroupId: String? = nil, taxFreeAmount: Int? = nil, vatAmount: Int? = nil,
    customer: Customer? = nil, windowType: WindowTypes? = nil, forceRedirect: Bool? = nil,
    noticeUrls: [String]? = nil, confirmUrl: String? = nil, appScheme: String? = nil,
    isEscrow: Bool? = nil, products: [Product]? = nil, isCulturalExpense: Bool? = nil,
    ...
    alipayPlus: PaymentRequestUnionAlipayPlus? = nil
  ) {
