...
public struct PaymentRequest: Codable {
  ...
  public init(
    storeId: String, paymentId: String, orderName: String, totalAmount: Int, currency: Currency,
    payMethod: PaymentPayMethod, channelKey: String? = nil, channelGroupId: String? = nil,
    taxFreeAmount: Int? = nil, vatAmount: Int? = nil, customer: Customer? = nil,
    windowType: WindowTypes? = nil, forceRedirect: Bool? = nil, noticeUrls: [String]? = nil,
    confirmUrl: String? = nil, appScheme: String? = nil, isEscrow: Bool? = nil,
    products: [Product]? = nil, isCulturalExpense: Bool? = nil, locale: PortOneLocale? = nil,
    customData: JSONValue? = nil, country: Country? = nil, productType: ProductType? = nil,
    offerPeriod: OfferPeriod? = nil, storeDetails: StoreDetails? = nil,
    shippingAddress: Address? = nil, promotionId: String? = nil, popup: Popup? = nil,
    iframe: Iframe? = nil, bypass: PaymentBypass? = nil, card: PaymentRequestUnionCard? = nil,
    ...
    alipay: PaymentRequestUnionAlipay? = nil,
    convenienceStore: PaymentRequestUnionConvenienceStore? = nil
  ) {
