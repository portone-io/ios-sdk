...
public struct IssueBillingKeyRequest: Codable {
  ...
  public init(
    ...
    productType: ProductType? = nil, bypass: IssueBillingKeyBypass? = nil, popup: Popup? = nil,
    iframe: Iframe? = nil, card: IssueBillingKeyRequestUnionCard? = nil,
    mobile: IssueBillingKeyRequestUnionMobile? = nil,
    easyPay: IssueBillingKeyRequestUnionEasyPay? = nil,
    paypal: IssueBillingKeyRequestUnionPaypal? = nil
  ) {
