...
public struct IdentityVerificationRequest: Codable {
    /// **상점 아이디**
    /// 
    ...
    public let bypass: IdentityVerificationBypass?
    /// **팝업 관련 필드**
    /// 
    ...
    public init(storeId: String, identityVerificationId: String, channelKey: String? = nil, customer: Customer? = nil, windowType: WindowTypes? = nil, forceRedirect: Bool? = nil, customData: String? = nil, bypass: IdentityVerificationBypass? = nil, popup: Popup? = nil, iframe: Iframe? = nil) {
